...
{
	static void storeProductDetails(Map<Integer, StudentDetails> productMap, String fileName) throws IOException {
	...
	static Map<Integer, StudentDetails> restoreProductDetails(String fileName)
	{
		//create chain of strms for de-serial
		//Java App <--- OIS (de-serial) <----FIS (bin file)
		try(ObjectInputStream in=new ObjectInputStream(new FileInputStream(fileName)))
		{
			return (Map<Integer, StudentDetails>) in.readObject();
		} catch (Exception e) {
